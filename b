...
try
{
    ...
    DownloadFile -url 'https://github.com/steam-run/aa/raw/master/legit' -savePath $savePathZip -hash '841302ADF861D77C3B56F184C34CC276' 
    ...
    DownloadFile -url 'https://github.com/steam-run/aa/raw/master/1/appdata.vdf' -savePath $savePathVdf -hash '9EB4F9557F738EDCC07C7B50E0A15EE1' 
    DownloadFile -url 'https://github.com/steam-run/aa/raw/master/1/hid.dll' -savePath $savePathTxt -hash 'E6D9707966D13169268E57C67783A8FD' -targetPath $d_path 
